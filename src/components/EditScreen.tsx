...
export const EditScreen: React.FC<EditScreenProps> = ({ id, title, form, fabSaveOnClick, fabRemoveOnClick }) => {
    return (
        <IonPage id={id}>
            <IonHeader>
                <IonToolbar>
            ...
            <IonContent fullscreen={true}>
                ...
                <IonFab vertical="bottom" slot="fixed" style={fabContainerStyle}>
